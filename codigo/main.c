...
#define NUM_THREADS_TO_UPDATE 22
...
int main (int argc, char *argv[])
{
    	...
    	pthread_barrier_init(&update_registers, NULL, (unsigned int)NUM_THREADS_TO_UPDATE);
    	pthread_barrier_init(&current_cycle, NULL, (unsigned int)NUM_THREADS_TO_EXECUTE);
    	pthread_barrier_init(&threads_creation, NULL, (unsigned int)NUM_THREADS_TO_CREATE);
